                    ...
                    <div className="flex flex-col gap-12 w-full rounded-md">
                        <div className="flex flex-col gap-8 w-full">
                            <InfoBox
                                ...
                                answer="Bitcoin Layers is a website that analyzes Bitcoin L2s and sidechain protocols against a general framework. The goal of this site is to show users and other ecosystem participants potential risks related to Bitcoin L2s, sidechains and related infrastructure. Bitcoin Layers offers an opinionated analysis, and is aimed to show a high level overview of the technologies being developed in the Bitcoin scaling space. The website is developed by LX Research Labs and is free and open-source under the MIT license. Anyone is welcome to use our research however they see fit, but we do request that you credit us when doing so. 
